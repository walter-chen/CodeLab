				...
				<div class="row">
					<div class="col-sm-6 col-sm-offset-3 form-box">
						...
						<div class="form-bottom">
							<form role="form" action="map" method="get" class="login-form">
								<button class="btn">活动告警地图展示模块</button>
							</form>
							<br>
							<form role="form" action="statistic" method="get"
								class="login-form">
								<button class="btn">告警数据统计模块</button>
							</form>
						</div>
					</div>
				</div>
